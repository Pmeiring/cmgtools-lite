...
# cd $pwd
# python DetermineCutFlow.py $CERNboxpath/N2_100GeV_2L $TTHpath/python/plotter/$cuts_2l | tee CutFlow_N2_100GeV_2l.log
# python DetermineCutFlow.py $CERNboxpath/N2_100GeV_2L_ee $TTHpath/python/plotter/$cuts_2l_ee | tee CutFlow_N2_100GeV_2l.log
# python DetermineCutFlow.py $CERNboxpath/N2_100GeV_2L_mumu $TTHpath/python/plotter/$cuts_2l_mm | tee CutFlow_N2_100GeV_2l.log
...
# cd $pwd
# python DetermineCutFlow.py $CERNboxpath/N2_200GeV_2L $TTHpath/python/plotter/$cuts_2l | tee CutFlow_N2_200GeV_2l.log
# python DetermineCutFlow.py $CERNboxpath/N2_200GeV_2L_ee $TTHpath/python/plotter/$cuts_2l_ee | tee CutFlow_N2_200GeV_2l.log
# python DetermineCutFlow.py $CERNboxpath/N2_200GeV_2L_mumu $TTHpath/python/plotter/$cuts_2l_mm | tee CutFlow_N2_200GeV_2l.log
...
cd $pwd
# python DetermineCutFlow_withStatError.py $CERNboxpath/N2_100GeV_2L_xsec $TTHpath/python/plotter/$cuts_2l | tee CutFlow_N2_100GeV_2l.log
# python DetermineCutFlow_withStatError.py $CERNboxpath/N2_100GeV_2L_ee_xsec $TTHpath/python/plotter/$cuts_2l_ee | tee CutFlow_N2_100GeV_2l.log
# python DetermineCutFlow_withStatError.py $CERNboxpath/N2_100GeV_2L_mumu_xsec $TTHpath/python/plotter/$cuts_2l_mm | tee CutFlow_N2_100GeV_2l.log
...
cd $pwd
# python DetermineCutFlow_withStatError.py $CERNboxpath/N2_200GeV_2L_xsec $TTHpath/python/plotter/$cuts_2l | tee CutFlow_N2_200GeV_2l.log
# python DetermineCutFlow_withStatError.py $CERNboxpath/N2_200GeV_2L_ee_xsec $TTHpath/python/plotter/$cuts_2l_ee | tee CutFlow_N2_200GeV_2l.log
# python DetermineCutFlow_withStatError.py $CERNboxpath/N2_200GeV_2L_mumu_xsec $TTHpath/python/plotter/$cuts_2l_mm | tee CutFlow_N2_200GeV_2l.log
